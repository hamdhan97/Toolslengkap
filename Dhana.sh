...
echo
echo $pur"==================="$cy" ============================="
echo $i""$pu"  AUTHOR  :  DHANA ABDI  "$i"                    "
echo $i""$pu"  WhatsApp:  +62 812-7392-623"$i"                "
echo $i""$pu"  GMAIL   :  Danaabdi86@gmail.com"$i"     "
echo $i""$pu"  YOUTUBE :  Dana Abdi"$i"                 "
echo $pur"==================="$cy" ============================="
echo
...
sleep 2
echo $ku"Facebook :"$i" dhana abdi"
echo $ku"YouTube  :"$i" Dana Abdi"
echo $ku"WhatsApp :"$i"+62 812-7392-623"
sleep 2
